...
const MOCK_PILGRIMS = [
  ...
  },
  {
    ...
    roomNumber: "Chambre 101 (RDC) • Lit N° 1",
    visaStatus: "issued"
  },
  {
    id: 2,
    ...
    roomNumber: "Chambre 204 (2ème Étage) • Lit N° 1",
    visaStatus: "issued"
  },
  {
    id: 3,
    ...
    hotelMakkah: "Abraj Al-Janadriyah",
    hotelMadinah: "Dar Al-Taqwa",
    roomNumber: "Chambre 101 (RDC) • Lit N° 2",
    visaStatus: "issued"
  },
  {
    id: 4,
  ...
  {
    id: 5,
    fullName: "El Hadji Mamadou Ba",
    phone: "+221 77 222 11 00",
    email: "mamadou.ba@etat.sn",
    passportNumber: "SN8877665",
    birthDate: "1954-03-15",
    bloodType: "O+",
    medicalStatus: "apte",
    registrationStatus: "approved",
    selectedAgencyId: 0,
    emergencyContact: { name: "Aïda Ba (Fille)", phone: "+221 77 111 22 33" },
    registrationDate: "2026-05-10",
    nusukSyncStatus: "synced",
    flightNumber: "VOL-ETAT-01 (Air Sénégal)",
    hotelMakkah: "Abraj Al-Janadriyah",
    hotelMadinah: "Dar Al-Taqwa",
    roomNumber: "Chambre 101 (RDC) • Lit N° 3",
    visaStatus: "issued"
  },
  {
    id: 6,
    ...
    passportNumber: "SN7766554",
    birthDate: "1985-08-20",
    bloodType: "A+",
    medicalStatus: "apte",
    registrationStatus: "approved",
    selectedAgencyId: 102,
    emergencyContact: { name: "Cheikh Tidiane (Époux)", phone: "+221 77 999 00 11" },
    registrationDate: "2026-06-01",
    nusukSyncStatus: "synced",
    flightNumber: "TX-202 (Dakar-Medina)",
    hotelMakkah: "Makkah Clock Royal Tower",
    hotelMadinah: "Pullman Zamzam Madina",
    roomNumber: "Chambre 302 (3ème Étage) • Lit N° 1",
    visaStatus: "issued"
  },
  {
    id: 7,
    fullName: "Babacar Faye",
    phone: "+221 70 444 55 66",
    email: "babacar.faye@dakarair.sn",
    passportNumber: "SN6655443",
    birthDate: "1978-11-12",
    bloodType: "AB+",
    medicalStatus: "apte",
    registrationStatus: "approved",
    selectedAgencyId: 2,
    emergencyContact: { name: "Ndeye Faye (Sœur)", phone: "+221 76 222 33 44" },
    registrationDate: "2026-06-15",
    nusukSyncStatus: "synced",
    flightNumber: "HC-2026-DKR",
    hotelMakkah: "Abraj Al Bait Royal Hotel",
    hotelMadinah: "Pullman Zamzam Madina",
    roomNumber: "Chambre 204 (2ème Étage) • Lit N° 2",
    visaStatus: "issued"
  },
  {
    id: 8,
    ...
    email: "aminata.seck@sahel.sn",
    passportNumber: "SN5544332",
    birthDate: "1990-01-25",
    bloodType: "O-",
    medicalStatus: "apte",
    registrationStatus: "approved",
    selectedAgencyId: 3,
    emergencyContact: { name: "Modou Seck (Frère)", phone: "+221 78 444 55 66" },
    registrationDate: "2026-06-14",
    nusukSyncStatus: "synced",
    flightNumber: "TX-203 (Dakar-Medina)",
    hotelMakkah: "Makkah Clock Royal Tower",
    hotelMadinah: "Dar Al-Taqwa",
    roomNumber: "Chambre 401 (4ème Étage) • Lit N° 1",
    visaStatus: "issued"
  },
  {
    id: 9,
    fullName: "Cheikh Tidiane Kane",
    phone: "+221 76 111 99 88",
    email: "cheikh.kane@madinah.sn",
    passportNumber: "SN4433221",
    birthDate: "1960-07-04",
    bloodType: "B+",
    medicalStatus: "apte",
    registrationStatus: "approved",
    selectedAgencyId: 4,
    emergencyContact: { name: "Khadija Kane (Fille)", phone: "+221 77 555 66 77" },
    registrationDate: "2026-06-05",
    nusukSyncStatus: "synced",
    flightNumber: "VOL-ETAT-02",
    hotelMakkah: "Abraj Al-Janadriyah",
    hotelMadinah: "Pullman Zamzam Madina",
    roomNumber: "Chambre 501 (5ème Étage) • Lit N° 1",
    visaStatus: "issued"
  },
  {
    id: 10,
    fullName: "Sokhna Fatou Diagne",
    phone: "+221 77 333 22 11",
    email: "sokhna.diagne@prestige.sn",
    passportNumber: "SN3322110",
    birthDate: "1975-12-18",
    bloodType: "A+",
    medicalStatus: "apte",
    registrationStatus: "approved",
    selectedAgencyId: 5,
    emergencyContact: { name: "Oumar Diagne (Époux)", phone: "+221 78 222 11 00" },
    registrationDate: "2026-06-12",
    nusukSyncStatus: "synced",
    flightNumber: "TX-VIP-01",
    hotelMakkah: "Makkah Clock Royal Tower",
    hotelMadinah: "Dar Al-Taqwa",
    roomNumber: "Chambre VIP-101 • Suite Royale",
    visaStatus: "issued"
  }
];
